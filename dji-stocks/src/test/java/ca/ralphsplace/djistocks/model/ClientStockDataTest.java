...
class ClientStockDataTest {
  ...
  void toTradeDataRecord() {
    ...
    Assertions.assertEquals(
        t1.getDaysToNextDividend(), c1.toStockDataRecord().getDaysToNextDividend());
    ...
    Assertions.assertEquals(
        t1.getPercentChangeNextWeeksPrice(), c1.getPercentChangeNextWeeksPrice());
    Assertions.assertEquals(
        t1.getPercentChangePrice(), c1.toStockDataRecord().getPercentChangePrice());
  }
}
